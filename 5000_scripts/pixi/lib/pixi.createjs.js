(function() {
			...
			value: function() {
				...
				return initAsync(this._basepath, this._composition)
					.then(function(data) {
						...
						var stage = _stage = new lib.Stage();
	...
	var appendixDescriptor = {
		...
		mask: {
			...
			set: function(value) {
				/*
				if (this._originParams.mask) {
					this._pixiData.instance.parent.removeChild(this._originParams.mask._pixiData.instance);
				}
				*/
	...
	createjs.MovieClip.prototype = Object.defineProperties(Object.create(createjsOrigin.MovieClip.prototype), Object.assign({
		...
		addChild: {
			value: function(child) {
				this._pixiData.instance.addChild(child._pixiData.instance);
				return createjsOrigin.MovieClip.prototype.addChild.call(this, child);
			}
		},
		addChildAt: {
			value: function(child, index) {
				this._pixiData.instance.addChildAt(child._pixiData.instance, index);
				return createjsOrigin.MovieClip.prototype.addChildAt.call(this, child, index);
			}
		},
		removeChild: {
			value: function(child) {
				this._pixiData.instance.removeChild(child._pixiData.instance);
				return createjsOrigin.MovieClip.prototype.removeChild.call(this, child);
			}
		},
		removeChildAt: {
			value: function(index) {
				this._pixiData.instance.removeChildAt(index);
	...
	createjs.Graphics.prototype = Object.defineProperties(Object.create(createjsOrigin.Graphics.prototype), Object.assign({
		...
		beginFill: {
			value: function(color) {
				if (!color) {
					this._pixiData.instance.beginFill(0, 0);
				} else {
					this._pixiData.instance.beginFill(parseInt(color.slice(1), 16), 1);
				}
		...
		beginStroke: {
			value: function(color) {
				if (!color) {
					this._pixiData.strokeFill = 0;
					this._pixiData.strokeAlpha = 0;
				} else {
					this._pixiData.strokeFill = parseInt(color.slice(1), 16);
					this._pixiData.strokeAlpha = 1;
				}
