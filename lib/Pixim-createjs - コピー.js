			...
			set: function(value) {
				if (this._pixiData.subInstance) {
					if (value) {
						...
						this._pixiData.subInstance.filters = list;
						this._pixiData.subInstance.cacheAsBitmap = true;
					} else {
						this._pixiData.subInstance.filters = null;
						this._pixiData.subInstance.cacheAsBitmap = false;
					}
				}
