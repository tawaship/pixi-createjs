 ...
 * @ignore
 */
export function initAsync(basepath: string, comp: any) {
 ...
 * @ignore
 */
export function initStage(stage: any, options: TCreatejsPlayerOption) {
	if (options.useSynchedTimeline) {
		...
		stage.update = function(props: any) {
 ...
 * @ignore
 */
function overrideCreatejs(self: any, pixi: any) {
	self._originParams = {
		x: 0,
		y: 0,
		scaleX: 0,
...
const EventMap = {
	mousedown: {
		types: ['pointerdown'],
		factory: function(self: any, cb: Function) {
