...
(lib.anim = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({rotation:360,x:487,y:338.95},65,cjs.Ease.quintIn).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-15.7,-15.7,518.5,370.4);
...
p.nominalBounds = new cjs.Rectangle(291,215.1,-243.5,-168.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/game_atlas_.png?1596506521653", id:"game_atlas_"}
	],
	preloads: []
};
